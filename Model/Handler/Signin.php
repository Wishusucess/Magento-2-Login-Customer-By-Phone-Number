...
namespace Wishusucess\SigninPhoneNumber\Model\Handler;
...
use Wishusucess\SigninPhoneNumber\Api\SigninInterface;
...
class Signin implements SigninInterface
{
    ...
    public function getByPhoneNumber(string $phone)
    {
        ...
        $customerFilter[] = $this->filterBuilder
            ->setField(\Wishusucess\SigninPhoneNumber\Setup\InstallData::PHONE_NUMBER)
            ->setConditionType('eq')
            ->setValue($phone)
            ->create();
